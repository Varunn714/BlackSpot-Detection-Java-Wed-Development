...
<head>
    ...
    <title>Reason Wise Report | Spot Finder</title>
            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">Reason Wise Report</h4>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-pills nav-secondary mb-5" id="pills-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" style="font-size: 18px;" id="pills-home-tab"
                                                data-toggle="pill" href="#pills-home" role="tab"
                                                aria-controls="pills-home" aria-selected="true">Crime Wise</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" style="font-size: 18px;" id="pills-profile-tab"
                                                data-toggle="pill" href="#pills-profile" role="tab"
                                                aria-controls="pills-profile" aria-selected="false">Accident Wise</a>
                                        </li>
                                    </ul>
									...
									%>
                                                        <div class="col-12 mb-3">
                                                            <h1 class="">Total Crime Black Spots : 
  									...
  									PreparedStatement ps1 = con.prepareStatement("select * from blackspot_details where pid=? and reason = ?");
  									ps1.setInt(1, Credentials.getPolice_id());
  									ps1.setString(2, "Crime");
								...
								<%
									...
									PreparedStatement ps2 = con.prepareStatement("select count(*) from blackspot_details where pid=? and reason = ?");
								ps2.setInt(1, Credentials.getPolice_id());
									ps2.setString(2, "Accident");
									...
									%>
									<div class="col-12 mb-3">
                                                            <h1 class="">Total Accident Black Spots : 
  									...
  									PreparedStatement ps3 = con.prepareStatement("select * from blackspot_details where pid=? and reason = ?");
  									ps3.setInt(1, Credentials.getPolice_id());
  									ps3.setString(2, "Accident");
