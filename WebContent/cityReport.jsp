            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">City Wise Report</h4>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-6">
                                            <h1 class=""><%= city %> City Report</h1>
                                        </div>
                                    </div>
									
									<div class="float-right ">
                                        <a href="cityWiseReport.jsp" class="btn btn-primary sm-btm">Back to search</a>
                                    </div>
									...
									PreparedStatement ps2 = con.prepareStatement("select count(*) from blackspot_details where pid=? and city like ?");
									...
									PreparedStatement ps = con.prepareStatement("select * from blackspot_details where pid = ? and city like ?");
