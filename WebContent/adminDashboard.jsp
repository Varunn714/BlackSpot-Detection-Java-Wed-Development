...
<head>
	...
	<title>Admin Dashboard | Spot Finder</title>
...
<% if((Credentials.isLoggedIn()) && (Credentials.getRole()=="admin")){ %>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#policeStation">
							...
							<div class="collapse" id="policeStation">
								<ul class="nav nav-collapse">
									<li>
										<a href="addPoliceStation.jsp">
											<span class="sub-item">Add Police Station</span>
										</a>
									</li>
									<li>
										<a href="viewPoliceStation.jsp">
											<span class="sub-item">View Police Station</span>
										</a>
									</li>
								</ul>
							</div>
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							...
							<div class="ml-md-auto py-2 py-md-0">
								<a href="addPoliceStation.jsp" class="btn btn-secondary btn-round">Add Station</a>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="card-body">
									...
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										<div class="px-2 pb-2 pb-md-0 text-center">
											...
											<h6 class="fw-bold mt-3 mb-0">Total Police Stations
											</h6>
										</div>
										<div class="px-2 pb-2 pb-md-0 text-center">
	...
	PreparedStatement ps3 = con.prepareStatement("select count(*) from blackspot_details");
...
<%
	PreparedStatement ps2 = con.prepareStatement("select count(*) from police_station");
	...
	PreparedStatement ps = con.prepareStatement("select count(*) from blackspot_details where reason = ?");
	...
	PreparedStatement ps1 = con.prepareStatement("select count(*) from blackspot_details where reason = ?");
	
	ps1.setString(1, "Accident");
