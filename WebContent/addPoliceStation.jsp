...
<% if((Credentials.isLoggedIn()) && (Credentials.getRole()=="admin")){ %>
                ...
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item active">
                            ...
                            <div class="collapse show" id="policeStation">
                                <ul class="nav nav-collapse">
                                    <li class="active">
            ...
            <div class="content">
                ...
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">Police Station</h4>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Add Police Station</div>
                                </div>

                                <form id="addForm" action="AddPoliceStation">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" class="form-control" id="email"
                                                        placeholder="Enter Station Email" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="password" class="form-control" id="password"
                                                        placeholder="Set Station Password" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea  name="address" class="form-control" id="address" rows="5" placeholder="Enter Station Address" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
	...
	$('#addForm').submit(function(e) {
		swal("Successfully Added! ", "New Police Station Added.", {
			icon: "success",
			buttons: {
				confirm: {
